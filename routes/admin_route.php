...
Route::group(['middleware' => 'isAdmin'] , function () {
    ...
    Route::get('/admin-profile-page',[AdminProfileController::class,'adminProfilePage'])->name('admin.profilepage');
    ...
    Route::get('/csv-export',[AddUserController::class,'csvExport'])->name('admin.csvexport');



    Route::get('/admin-package',[PackageController::class,'package'])->name('admin.package');
    ...
    Route::post('/kyc-verified-ajax',[KycController::class,'kycVerifiedAjax'])->name('admin.kyc.verified-user-ajax');


   //Payment Route
   Route::get('/payment',[PaymentController::class,'paymentPage'])->name('admin.payment');
   Route::get('/invoices',[PaymentController::class,'invoicesPage'])->name('admin.invoice');
